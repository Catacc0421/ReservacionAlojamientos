...
public class AlojamientoApartamento extends Alojamiento {
    ...
    @Builder
    public AlojamientoApartamento(String id, String nombreAlojamiento, String ciudad, String descripcion, File image, List<TipoServicio> serviciosIncluidos, double costoAseo,double costoMantenimiento, double precioNoche, int capacidadMaxima, OfertaRangoFechas ofertaRangoFechas, OfertaEstancia ofertaEstancia, List<Resena> resenas) {
